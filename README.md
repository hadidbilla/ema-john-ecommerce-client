This is a ecommerce web application. IN this project i use react for the frontend part and i use node.js and express.js for the backend part. I use mongoDB fot the database part.
